...
angular.module('commercialApp.services')
  .factory('ValidadorDocumento', [function() {
    ...
    function valida_cpf_cnpj ( valor ) {
      ...
      if (checarNumerosIguais(valor)) return false;
    ...
    function checarNumerosIguais(valor) {
      var result = true, i = 0;

      for (i = 0; i < valor.length - 1; i++) {
        if (valor.substr(i, 1) !== valor.substr(i + 1, 1)) {
          result = false;
          break;
        }
      }
